...
\leftheader{%
  {\LARGE\bfseries\sffamily Kichou Nadir, Master's Student.}
...
% create a rubric on "knowledges" are add it as a subsection to the "skills" section. This section will include all the courses and things learned during this year. 

\makerubric{skills}
\makerubric{misc}

\makerubric{motivations}
